 ...
 * Описание: Пользователь нажимает на иконку кисти или ластика. Затем пользователь нажимает левой кнопкой мыши на холст и двигает мышкой. Если на холсте появляется линия черного цвета, то была выбрана кисть, если белого, то был выбран ластик. 
