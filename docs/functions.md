 ...
 * Описание: на экране приложения расположены: панель с инструментами, холст, меню. Пользователь может со всем взаимодействовать. Пользователь взаимодействует с панелью с цветами - меняется цвет кисти, цвет внутренней части фигуры или цвет обводки фигуры. Пользователь взаимодействует с фигурами: нажимает на иконку фигуры, задает ей форму на холсте, двигает.
___
